...
export class CoveragesComponent implements OnInit {
    ...
    adultcount: number = 0;
    onlythreekidserror:boolean=false;
    ...
    roomtypestring: any = 'single';
    chornic: any = 'NCHR'
    dieseasecounter: number = 0;
    criticalillnessfactor: number = 1;
    ...
    coverArray: any = [
        ...
        {
            'id': 5,
            'name': 'International Coverage for Major Illness ',
            'selected': false
        ...
        {
            'id': 6,
            'name': 'Hospital Cash Benifit Cover',
            'selected': false
        ...
        {
            'id': 9,
            'name': 'Cancer Hospitelization Booster',
            'selected': false
    ...
    maxageinselfandspouse:number=18;
    ...
    constructor(private router: Router, private componentService: ComponentService, private quoteService: QuoteService, private sumService: SumService, private infoService: InfoService, private pincodeService: PincodeService,
        ...
        this.infoService.platinumPlan = localStorage.getItem('planname');
    ...
    setInitial() {
        if (localStorage.getItem('tenur') == null) {
            this.tenure = '1 Year'
        }
        ...
        setTimeout(() => {
            if (this.plancode == 3) {
                this.roomtypestring = 'any';
                for (let i = 0; i < this.modelarray.length; i++) {
                    this.modelarray[i].roomfactor = 1;
                }
            }
            if (this.plancode !== 3) {
                this.roomtypestring = 'Single AC';
                for (let i = 0; i < this.modelarray.length; i++) {
                    this.modelarray[i].roomfactor = 1;
                }
            }
    ...
    selectmember(id: any) {
        ...
        if (this.modelarray[id].age == '') {
            this.modelarray[id].ageerror = true;
            setTimeout(() => { this.modelarray[id].ageerror = false; }, 2000);
            this.modelarray[id].preselected = false;
            return;
        }
        ...
        if (this.policyType == 'multiIndividual') {
            ...
            if (this.modelarray[id].selected == false) {
                ...
                if (this.modelarray[id].age !== null) {
                ...
                if (this.deleteselected || this.modelarray[id].age == null) {
        ...
        if (this.policyType == 'familyFloater') {
            ...
            if (this.modelarray[id].selected == false) {
                ...
                if (this.modelarray[id].age !== null) {
                    ...
                    if (this.modelarray[id].iskid == true) {
                        let floater = '';
                        if (this.kidcounter == 1) { floater = 'Kid1'; }
                        if (this.kidcounter == 2) { floater = 'Kid2'; }
                        if (this.kidcounter == 3) { floater = 'Kid3'; }
                        this.modelarray[id].floater = floater
                    }

                    this.setFamilyFloater();
                    if ((this.adultcount * 1 + this.kidcounter * 1) >= 2) {
                        this.checkFloater()
                        if (!this.isFloaterValid) {
                            this.modelarray[id].selected = false;
                            return;
                        }
                    }
    ...
    findFinalPremium() {
        ...
        this.coverArray[1].premium = this.abhiPremiumTotal;
        this.coverArray[2].premium = this.personalAccidentPremium;
        this.coverArray[3].premium = this.criticalIllnessPremium;
        this.coverArray[4].premium = this.internationalCoveragePremium;
        this.coverArray[5].premium = this.hospitalCashPremium;
        this.coverArray[7].premium = this.futureSecurePremium;
        this.coverArray[8].premium = this.cancerHospitalizationPremium;
        this.coverArray[9].premium = this.vaccineCoverPremium;
        this.coverArray[10].premium = this.teleopdPremium;

        this.basicpremium = Math.round(this.premiumshow);

        this.masterpremium = this.premiumshow * 1 +
            this.personalAccidentPremium * 1 + this.criticalIllnessPremium * 1 +
            this.internationalCoveragePremium * 1 + this.hospitalCashPremium * 1 + this.abhiPremiumTotal * 1
            + this.futureSecurePremium * 1 + this.cancerHospitalizationPremium * 1 + this.vaccineCoverPremium * 1
            + this.teleopdPremium * 1;
        console.log('master premium before gst ' + this.masterpremium)
        ...
        this.masterpremium = Math.round(this.masterpremium)
        console.log('gst applied')
        console.log(this.masterpremium)
        let p: any = (this.masterpremium).toFixed(2);
    ...
    setMaster() {
        ...
        if (this.infoService.platinumPlan == 'platinumEssential') {
            this.master = this.dataService.platinumEssential;
            this.plan = 'Activ Health Platinum Essential Plan';
            this.plancode = 1;
            console.log(this.plan)
        }
        if (this.infoService.platinumPlan == 'platinumEnhanced') {
            this.master = this.dataService.platinumEnhancedMaster;
            this.plan = 'Activ Health Platinum Enhanced Plan';
            this.plancode = 2;

            console.log(this.plan)
        }
        if (this.infoService.platinumPlan == 'platinumPremiere') {
            this.master = this.dataService.platinumPremiere;
            this.plan = 'Activ Health Platinum Premier Plan';
            this.plancode = 3;
    ...
    findSI(id: any) {
        if (this.policyType == 'multiIndividual') {
            ...
            this.premiumshow = 0;
            for (let i = 0; i < this.modelarray.length; i++) {
                if (this.modelarray[i].dieseasecounter == 0) {
                    this.modelarray[i].chronic = 'NCHR'
                }

                if (this.modelarray[i].selected) {
                    console.log(this.modelarray[i].member + ' dieseasecounter >> ' + this.modelarray[i].dieseasecounter + ' chornic >>  ' + this.modelarray[i].chronic)
                    this.modelarray[i].premium = 0;
                    console.log(this.modelarray[i].chronic)
                    y = this.master.filter((x: any) => {
                        if (x['familY_FLOATER'] == this.modelarray[i].gender && x["prE_EXISTING"] == this.modelarray[i].chronic
                            && x['age'] == this.modelarray[i].age)
                            return x;
                    }
                    );

                    console.log(y);
                    console.log(this.modelarray[i].dieseasepremium)
                    premiumpre = y[0][this.modelarray[i].sum] * 1 + this.modelarray[i].dieseasepremium * 1;

                    console.log(">>" + premiumpre)
                    let z = this.getZoneFactor(this.modelarray[i].sumtoshow);

                    console.log('zonefactor ' + z)
                    premiumpre = premiumpre * z;
                    premiumpre = premiumpre * this.modelarray[i].roomfactor;
                    this.modelarray[i].premium = premiumpre;
                    console.log('roomfactor >> ' + this.modelarray[i].roomfactor + '  zonefactor >> ' + this.zonefactor)
                    ...
                    if (this.tenure == '2 Year') {
                        ...
                        console.log(this.premiumshow)
                        console.log(this.modelarray[i].premium)
                        this.premiumshow = this.premiumshow * 1 + this.modelarray[i].premium * 1;

                        console.log('premiumshow after 2 years >>>' + this.premiumshow)
                    ...
                    console.log('premium after zone and room ' + this.modelarray[i].member + ' ' + this.modelarray[i].premium)
                }
            }
        ...
        if (this.policyType == 'familyFloater') {
            ...
            y = 'Empty';
            let higherage: any;
            if (this.modelarray[0].age >= this.modelarray[1].age) { higherage = this.modelarray[0].age }
            else { higherage = this.modelarray[1].age };
            console.log('higher age >>> ' + higherage)

            y = this.master.filter((x: any) => {
                if (x['familY_FLOATER'] == this.familyFloater && x["prE_EXISTING"] == this.chornic
                    && x['age'] == higherage)
                    return x;
            }
            );
            ...
            let z = this.getZoneFactor(this.sumindigits)
            console.log('roomfactor >> ' + this.roomfactor)
            console.log('zonefactor >> ' + z)

            this.premiumshow = this.premiumvalue * z * this.roomfactor;
            console.log(this.premiumshow);

            // this.premiumshow = parseInt((this.premiumshow).toFixed(4))

            if (this.tenure == '2 Year') {
                let int: number = parseInt(higherage);
                int++;
                higherage = int.toString()
                ...
                console.log('roomfactor ' + this.roomfactor);
                console.log('zonefactor ' + this.zonefactor);

                this.premiumvalue = this.premiumvalue * z * this.roomfactor
                console.log('premium for second year ' + this.premiumvalue)
            ...
            if (this.tenure == '3 Year') {
                ...
                let int4: number = parseInt(higherage);
                int4++;
                higherage = int4.toString()
        ...
        if (this.tenure == '2 Year') {
            this.premiumshow = this.premiumshow * 0.925;
            let a: any = (this.premiumshow).toFixed(4);
            this.premiumshow = parseInt(a);
            console.log('7.5% % discout applied for 2 year');
        }
        if (this.tenure == '3 Year') {
            this.premiumshow = this.premiumshow * 0.9;
            // let p: any = (this.premiumshow).toFixed(4);
            // this.premiumshow = parseInt(p);
            console.log('10 % discout applied for 3 year');
        }
        let counter: number = (this.adultcount * 1 + this.kidcounter * 1)
        console.log('members ' + counter)
        if (this.policyType == 'multiIndividual' && counter == 2) {
            this.premiumshow = this.premiumshow * 0.95;
            console.log('MI discount 5% applied')
        }
        console.log(this.premiumshow)
        if (this.policyType == 'multiIndividual' && counter >= 3) {
            this.premiumshow = this.premiumshow * 0.9;
            console.log('MI discount 10% applied')
        }
        console.log(this.premiumshow)
    ...
    checkFloater() {
        ...
        if (this.infoService.platinumPlan == 'platinumPremiere') {
            if (
                this.familyFloater == 'Self' ||
                this.familyFloater == 'Self+Spouse+Kid1' ||
                this.familyFloater == 'Self+Spouse+Kid1+Kid2' ||
                this.familyFloater == 'Self+Spouse+Kid1+Kid2+Kid3' ||
                this.familyFloater == 'Self+Kid1' ||
                this.familyFloater == 'Self+Kid1+Kid2' ||
                this.familyFloater == 'Self+Kid1+Kid2+Kid3 ' ||
                this.familyFloater == 'Spouse+Kid1' ||
                this.familyFloater == 'Spouse+Kid1+Kid2' ||
                this.familyFloater == 'Spouse+Kid1+Kid2+Kid3'

            ) {
                this.isFloaterValid = true;
            }
            else {
                this.isFloaterValid = false;
            }
            ...
            if (
                ...
                this.familyFloater == 'Self + Kid1 + Kid2' ||
                this.familyFloater == 'Self + Kid1 + Kid2 + Kid3' ||
                this.familyFloater == 'Self + Spouse'
            ) {
                this.isFloaterValid = true;
            }
            else {
        ...
        if (this.familyFloater == 'Self') {
            this.selectatleasttwomembers = true;
            setTimeout(() => { this.selectatleasttwomembers = false }, 1500)
        }
        console.log('floater >>>' + this.familyFloater)
        console.log('isFloaterValid  >>>' + this.isFloaterValid)

    }

    addson() {
        if(this.kidcounter>=3){
            this.onlythreekidserror=true;
            setTimeout(()=>{
                this.onlythreekidserror=false;
            },1500)
            return;
        }
        ...
        if (this.soncounter < 4 && this.soncounter >= 0) {
            ...
            if (!this.modelarray[6].selected && id == 6) {
                this.soncounter++;
                this.modelarray[6].masterselected = true;
            }
            else {
                if (this.modelarray[--id].selected) {
    ...
    removeson() {
        if (this.soncounter <= 4 && this.soncounter >= 1) {
            let id = 5;
            id = id * 1 + this.soncounter;
            this.modelarray[id].masterselected = false;
            this.modelarray[id].premium = 0;

            if (this.modelarray[id].age == ''  || this.modelarray[id].age==null) {
                ...
                setTimeout(() => {
                    this.selectmember(id);   // in this fn soncounter-- will take place
                }, 400);
    ...
    adddaughter() {
        ...
        if (this.daughtercounter < 4 && this.daughtercounter >= 0) {
            ...
            if (!this.modelarray[2].selected && id == 2) {
                this.daughtercounter++;
                this.modelarray[2].masterselected = true;
            }
            else {
                if (this.modelarray[--id].selected) {
                    this.modelarray[++id].masterselected = true;
    ...
    removedaughter() {
        if (this.daughtercounter <= 4 && this.daughtercounter >= 1) {
            ...
            if (this.modelarray[id].age == '' || this.modelarray[id].age==null) {
                ...
                this.deleteselected = true;
                setTimeout(() => {
                    this.selectmember(id);   // in this fn daughtercounter-- will take place
                }, 400);
    ...
    setFamilyFloater() {
        ...
        if (this.infoService.platinumPlan == 'platinumPremiere') {
            for (let i = 0; i < this.modelarray.length; i++) {
                if (this.modelarray[i].selected == true && this.modelarray[i].age !== '') {
                    if (i == 0) {
                        this.familyFloater = this.familyFloater + this.modelarray[i].floater;
                    }
                    else if (i == 1 && this.modelarray[0].selected == false) {
                        this.familyFloater = this.modelarray[0].floater;
                    }
                    else this.familyFloater = this.familyFloater + '+' + this.modelarray[i].floater;
                }
            }
            console.log('in setfamilyfloater >> ' + this.familyFloater)
            ...
            for (let i = 0; i < this.modelarray.length; i++) {
                if (this.modelarray[i].selected == true && this.modelarray[i].age !== '') {
                    if (i == 0) {
                        this.familyFloater = this.modelarray[i].floater;
                    }
                    else if (i == 1 && this.modelarray[0].selected == false) {
                        this.familyFloater = this.modelarray[0].floater;
                    }
    ...
    setMembersString() {
        this.membersString = '';
        if (this.policyType == 'familyFloater' && this.isFloaterValid == false) {
            return;
        }
    ...
    setTenure(tenure: any) {
        ...
        // this.findSI(1);  
        // in calDieseasePremiu findSI() will get called.
        this.calDieseasePremium();
        // this.resetCovers();
        this.addCovers()
        // setTimeout(() => {
        //     this.findFinalPremium();
    ...
    setSI(sum: any, id: any) {
        ...
        if (this.policyType == 'multiIndividual') {
            ...
            this.modelarray[id].sumtoshow = this.sumService.set2(sum.detail.value);

        }

        if (this.policyType == 'familyFloater') {
            this.sum = sum.detail.value;
            this.sumtoshow = this.sumService.set2(this.sum);
        }
        this.tenurechange = true;
        setTimeout(() => {
            this.tenurechange = false;
    ...
    setAge(event: any, id: any) {
        ...
        let maxage=0;
        if(this.modelarray[0].age!==null && this.modelarray[1].age==null)
        {maxage=this.modelarray[0].age}
       else if(this.modelarray[0].age==null && this.modelarray[1].age!==null)
       {maxage=this.modelarray[1].age}
    else
        {
        
            if(this.modelarray[1].age>this.modelarray[0].age)
            { maxage=this.modelarray[1].age}
            else{
                maxage=this.modelarray[0].age;
            }
    ...
    setPincode() {
        ...
        setTimeout(() => {
            ...
            if (y[0]['abhI_ZONE_MAP'] == 'Z003') {
                this.zone = 'Z003';
                localStorage.setItem('zone', 'Z003');
                localStorage.setItem('pincode', this.pincode)
    ...
    getZoneFactor(sum: any) {

        //         when @SIval<=300000 and @zone='1'  THEN '0'          
        //    when @SIval<=300000 and @zone='2'  THEN '10'          
        //    when @SIval<=300000 and @zone='3'  THEN '23.5'          
        //    when @SIval>=400000 and @zone='1'  THEN '0'          
        //    when @SIval>=400000 and @zone='2'  THEN '9'          
        //    when @SIval>=400000 and @zone='3'  THEN '21.5'
        ...
        if (this.zone == 'Z002') {
            if (sum <= 300000) this.zonefactor = 0.9;
            if (sum >= 400000) this.zonefactor = 0.91;
        }
        if (this.zone == 'Z003') {
            if (sum <= 300000) this.zonefactor = 0.765;
            if (sum >= 400000) this.zonefactor = 0.785;
        }

        if (this.plancode == 3) {
            if (this.zone == 'Z001') { this.zonefactor = 1 }
            if (this.zone == 'Z002') { this.zonefactor = 0.91 }
            if (this.zone == 'Z003') { this.zonefactor = 0.77 }
    ...
    setRoomTypeFloater(event: any) {
        ...
        if (this.roomfactor == 1) { localStorage.setItem('roomtypestring', 'single') }
        if (this.roomfactor == 1.1) { localStorage.setItem('roomtypestring', 'any') }
        if (this.roomfactor == 0.9) { localStorage.setItem('roomtypestring', 'shared') }
        this.findSI(1);
        this.findFinalPremium();
    ...
    setRoomType(event: any,member:any) {
        ...
        let rf=event.detail.value;
        let p: any = this.roomfactor.toString()
        localStorage.setItem('roomfactor', p);
        if (rf == 1) { this.modelarray[member.id].roomtypestring='Single Ac' }
        if (rf == 1.1) { this.modelarray[member.id].roomtypestring='Any' }
        if (rf == 0.9) {this.modelarray[member.id].roomtypestring='Shared'  }
        this.findSI(1);
        this.findFinalPremium();
    ...
    addCovers() {
        ...
        if (this.coverArray[1].selected) this.selectAbhiProtect();
        if (this.coverArray[2].selected) this.selectMemberPersonalAccident();
        if (this.coverArray[3].selected) this.selectMemberCriticalIllness()
        if (this.coverArray[4].selected) this.selectMemberInternationalCoverage();
        if (this.coverArray[5].selected) this.selectHospitalCash();

        if (this.coverArray[7].selected) this.selectFutureSecure();
        if (this.coverArray[8].selected) this.selectCancerHospitalization();
        if (this.coverArray[9].selected) this.selectMemberTeleOpd();
        if (this.coverArray[10].selected) this.selectVaccineCover();
    }

    //
    selectAbhiProtect() {
        this.abhiPremiumTotal = 0;
        for (let i = 0; i < this.modelarray.length; i++) {

            if (this.modelarray[i].selected) {
                this.modelarray[i].abhiprotect = true;
                let y: any;
                y = this.abhimaster.abhimaster.filter((x: any) => {
                    if (x['adultCount'] == this.adultcount && x['childCount'] == this.kidcounter && x['minAge'] <= this.modelarray[i].age &&
                        x['maxAge'] >= this.modelarray[i].age && x['minSI'] <= 10000 && x['maxSI'] >= 10000
                    )
                        return x;
                });
                console.log(y);
                let p: any = (y[0].premium);
                this.modelarray[i].abhiPremium = p;
                console.log(this.modelarray[i].member + ' abhi premium for 1 year >>> ' + this.modelarray[i].abhiPremium);

                if (this.tenure == '2 Year') {

                    let age: number = this.modelarray[i].age;
                    age++;
                    this.modelarray[i].age = age;
                    ...
                    console.log(y);
                    let p: any = (y[0].premium);
                    this.modelarray[i].abhiPremium = this.modelarray[i].abhiPremium * 1 + p * 1;
                    console.log(this.modelarray[i].member + ' abhi premium for 2 year >>> ' + this.modelarray[i].abhiPremium);
                ...
                if (this.tenure == '3 Year') {
                    ...
                    console.log(y);
                    let t: any = (y[0].premium);
                    this.modelarray[i].abhiPremium = this.modelarray[i].abhiPremium * 1 + t * 1;
                    age++;
                    this.modelarray[i].age = age;
                    let r: any;
                    r = this.abhimaster.abhimaster.filter((x: any) => {
                        if (x['adultCount'] == this.adultcount && x['childCount'] == this.kidcounter && x['minAge'] <= this.modelarray[i].age &&
                            x['maxAge'] >= this.modelarray[i].age && x['minSI'] <= 10000 && x['maxSI'] >= 10000
                        )
                            return x;
                    ...
                    console.log(y);
                    let k: any = (y[0].premium);
                    this.modelarray[i].abhiPremium = this.modelarray[i].abhiPremium * 1 + k * 1;

                    console.log('abhi premium for 3 year ' + this.modelarray[i].abhiPremium);
                    age--;
                    age--;
                    this.modelarray[i].age = age;
                }
                ...
                if (this.modelarray[i].abhiPremium !== 0) {
                    this.abhiPremiumTotal = this.abhiPremiumTotal * 1 + this.modelarray[i].abhiPremium * 1;
                }
                console.log('abhipremiumtotal ' + this.abhiPremiumTotal);
                this.coverArray[1].premium = this.abhiPremiumTotal;
            }
        }
        setTimeout(() => {
    ...
    removeAbhiProtect() {
        for (let i = 0; i < this.modelarray.length; i++) {
            if (this.modelarray[i].selected) {
                this.modelarray[i].abhiprotect = false;
                this.modelarray[i].abhiPremium = ''
            }
            this.abhiPremiumTotal = 0;

        }
        this.coverArray[1].premium = '';
        this.findFinalPremium();
    }
    ...
    selectPA() {
        for (let i = 0; i < this.modelarray.length; i++) {
            if (this.plancode == 3 && this.modelarray[i].iskid) {
                this.modelarray[i].pASI = '1000000'
            }
            if (this.plancode !== 3 && this.modelarray[i].iskid) {
                this.modelarray[i].pASI = '500000'
            }
    ...
    selectMemberPersonalAccident() {
        ...
        if (this.tenure == '2 Year') {
            this.personalAccidentPremium = this.personalAccidentPremium * 2;
            this.personalAccidentPremium = this.personalAccidentPremium * 0.925;
            this.personalAccidentPremium = Math.round(this.personalAccidentPremium);
        }
        if (this.tenure == '3 Year') {
            this.personalAccidentPremium = this.personalAccidentPremium * 3;
            this.personalAccidentPremium = this.personalAccidentPremium * 0.9;
            this.personalAccidentPremium = Math.round(this.personalAccidentPremium);

        }
        if ((this.adultcount * 1 + this.kidcounter * 1) == 2 && this.policyType == 'multiIndividual') {
            this.personalAccidentPremium = this.personalAccidentPremium * 0.95
        }
        if ((this.adultcount * 1 + this.kidcounter * 1) >= 2 && this.policyType == 'multiIndividual') {
            this.personalAccidentPremium = this.personalAccidentPremium * 0.90
        }
    ...
    setRFPersonalAccident(event: any, member: any) {
      debugger
        this.modelarray[member].riskfactor = parseInt(event.detail.value.Risk_class);
        console.log(this.modelarray[member.id].member +' riskfactor '+ this.modelarray[member.id].riskfactor)
        this.personalAccidentPremium = 0;
        this.selectMemberPersonalAccident();
    }

    setSIPersonalAccident(event: any, id: any) {

        this.modelarray[id].pASI = event.detail.value;
        if (event.detail.value == '1000000') { this.modelarray[id].pASIInLakhs = '10 Lakhs' }
        if (event.detail.value == '1500000') { this.modelarray[id].pASIInLakhs = '15 Lakhs' }
        if (event.detail.value == '2000000') { this.modelarray[id].pASIInLakhs = '20 Lakhs' }
        if (event.detail.value == '3000000') { this.modelarray[id].pASIInLakhs = '30 Lakhs' }
        if (event.detail.value == '5000000') { this.modelarray[id].pASIInLakhs = '50 Lakhs' }
        if (event.detail.value == '10000000') { this.modelarray[id].pASIInLakhs = '1 Cr' }
    ...
    setCriticalIllnessFactor(age: any) {
        if (this.infoService.platinumPlan == 'platinumEnhanced' || this.infoService.platinumPlan == 'platinumEssential') {
            if (age >= 66 && age <= 99) this.criticalillnessfactor = 61.325;
            if (age >= 61 && age <= 65) this.criticalillnessfactor = 40.997;
            if (age >= 56 && age <= 60) this.criticalillnessfactor = 26.400;
            if (age >= 51 && age <= 55) this.criticalillnessfactor = 15.620;
            if (age >= 46 && age <= 50) this.criticalillnessfactor = 9.977;
            if (age >= 41 && age <= 45) this.criticalillnessfactor = 6.402;
            if (age >= 36 && age <= 40) this.criticalillnessfactor = 3.905;
            if (age >= 26 && age <= 35) this.criticalillnessfactor = 2.156;
            if (age >= 18 && age <= 25) this.criticalillnessfactor = 1.364;
        }
        if (this.infoService.platinumPlan == 'platinumPrmiere') {
            if (age >= 66 && age <= 99) this.criticalillnessfactor = 55.7455;
            if (age >= 61 && age <= 65) this.criticalillnessfactor = 37.2727;
            if (age >= 56 && age <= 60) this.criticalillnessfactor = 24;
            if (age >= 51 && age <= 55) this.criticalillnessfactor = 14.2;
            if (age >= 46 && age <= 50) this.criticalillnessfactor = 9.07273;
            if (age >= 41 && age <= 45) this.criticalillnessfactor = 5.81818;
            if (age >= 36 && age <= 40) this.criticalillnessfactor = 3.54545;
            if (age >= 26 && age <= 35) this.criticalillnessfactor = 1.96364;
            if (age >= 18 && age <= 25) this.criticalillnessfactor = 1.23636;
        }
    }
    ...
    selectMemberCriticalIllness() {
        ...
        for (let i = 0; i < this.modelarray.length; i++) {
            if (!this.modelarray[i].criticalillness) {
                ...
                this.setCriticalIllnessFactor(this.modelarray[i].age)
                this.modelarray[i].cIPremium = (this.modelarray[i].cISI * this.criticalillnessfactor) / 1000;
                console.log(this.modelarray[i].member + ' CI premium added >>> ' + this.modelarray[i].cIPremium);

                if (this.tenure == '2 Year') {
                    let age: number = this.modelarray[i].age;
                    age++;
                    this.setCriticalIllnessFactor(age)
                    let nextyearpremium: number = 0;
                    nextyearpremium = (this.modelarray[i].cISI * this.criticalillnessfactor) / 1000;
                    this.modelarray[i].cIPremium = this.modelarray[i].cIPremium * 1 + (nextyearpremium) * 1;
                ...
                if (this.tenure == '3 Year') {
                    ...
                    age++;
                    this.setCriticalIllnessFactor(age)
                    let nextnextyearpremium: number = 0;
                    nextnextyearpremium = (this.modelarray[i].cISI * this.criticalillnessfactor) / 1000;
                    this.modelarray[i].cIPremium = this.modelarray[i].cIPremium * 1 + (nextnextyearpremium) * 1;
        ...
        setTimeout(() => {
            if (this.tenure == '2 Year') {
                this.criticalIllnessPremium = this.criticalIllnessPremium * 1;
                this.criticalIllnessPremium = this.criticalIllnessPremium * 0.925;
                this.criticalIllnessPremium = Math.round(this.criticalIllnessPremium);
            }
            if (this.tenure == '3 Year') {
                this.criticalIllnessPremium = this.criticalIllnessPremium * 1;
                this.criticalIllnessPremium = this.criticalIllnessPremium * 0.9;
                this.criticalIllnessPremium = Math.round(this.criticalIllnessPremium);
            }

            if ((this.adultcount * 1 + this.kidcounter * 1) == 2 && this.policyType == 'multiIndividual') {
                this.criticalIllnessPremium = this.criticalIllnessPremium * 0.95;
            }
            if ((this.adultcount * 1 + this.kidcounter * 1) >= 3 && this.policyType == 'multiIndividual') {
                this.criticalIllnessPremium = this.criticalIllnessPremium * 0.90;
            }
    ...
    setSIInternationalCoverage(event: any, id: any) {
        this.modelarray[id].iCSI = event.detail.value;
        this.internationalCoveragePremium = 0;
        this.selectMemberInternationalCoverage();
    }

    setICPremium(i: any) {
        let a: any = this.modelarray[i].age;

        if (this.modelarray[i].iCSI == '30000000') {

            if (a >= 0 && a <= 4) { this.modelarray[i].iCPremium = 9440 };
            if (a >= 5 && a <= 17) { this.modelarray[i].iCPremium = 9373 };
            if (a >= 18 && a <= 25) { this.modelarray[i].iCPremium = 9373 };
            if (a >= 26 && a <= 35) { this.modelarray[i].iCPremium = 10314 };
            if (a >= 36 && a <= 40) { this.modelarray[i].iCPremium = 17394 };
            if (a >= 41 && a <= 45) { this.modelarray[i].iCPremium = 18835 };
            if (a >= 46 && a <= 50) { this.modelarray[i].iCPremium = 30534 };
            if (a >= 51 && a <= 55) { this.modelarray[i].iCPremium = 34765 };
            if (a >= 56 && a <= 60) { this.modelarray[i].iCPremium = 51973 };
            if (a >= 61 && a <= 65) { this.modelarray[i].iCPremium = 80507 };
            if (a >= 66 && a <= 70) { this.modelarray[i].iCPremium = 120824 };
            if (a >= 71 && a <= 75) { this.modelarray[i].iCPremium = 178850 };
            if (a >= 76 && a <= 99) { this.modelarray[i].iCPremium = 261870 };
        }
        if (this.modelarray[i].iCSI == '60000000') {
            if (a >= 0 && a <= 4) { this.modelarray[i].iCPremium = 11800 };
            if (a >= 5 && a <= 17) { this.modelarray[i].iCPremium = 11717 };
            if (a >= 18 && a <= 25) { this.modelarray[i].iCPremium = 11717 };
            if (a >= 26 && a <= 35) { this.modelarray[i].iCPremium = 12890 };
            if (a >= 36 && a <= 40) { this.modelarray[i].iCPremium = 21744 };
            if (a >= 41 && a <= 45) { this.modelarray[i].iCPremium = 23546 };
            if (a >= 46 && a <= 50) { this.modelarray[i].iCPremium = 38168 };
            if (a >= 51 && a <= 55) { this.modelarray[i].iCPremium = 43456 };
            if (a >= 56 && a <= 60) { this.modelarray[i].iCPremium = 64968 };
            if (a >= 61 && a <= 65) { this.modelarray[i].iCPremium = 100634 };
            if (a >= 66 && a <= 70) { this.modelarray[i].iCPremium = 151030 };
            if (a >= 71 && a <= 75) { this.modelarray[i].iCPremium = 223565 };
            if (a >= 76 && a <= 99) { this.modelarray[i].iCPremium = 327336 };
        }
    }

    removeInternationalCoverage() {
        for (let i = 0; i < this.modelarray.length; i++) {
            if (this.modelarray[i]) {
                this.modelarray[i].internationalcoverage = false;
                this.modelarray[i].iCPremium = 0;
            };
        }
        this.internationalCoveragePremium = 0;
        this.coverArray[4].premium = '';

        this.findFinalPremium();

    }

    selectMemberInternationalCoverage() {
        this.internationalCoveragePremium = 0;
        for (let i = 0; i < this.modelarray.length; i++) {
            if (!this.modelarray[i].internationalcoverage) {
                this.modelarray[i].iCPremium = 0;
            }
            else {
                this.setICPremium(i);
                this.modelarray[i].iCPremium = parseInt(this.modelarray[i].iCPremium).toFixed(4)
                console.log(this.modelarray[i].member + ' Int Cov premium added >>> ' + this.modelarray[i].iCPremium);
                if (this.tenure == '2 Year') {

                    let age: number = this.modelarray[i].age;
                    age++;
                    this.modelarray[i].age = age;
                    let premiumpre: number = this.modelarray[i].iCPremium;
                    this.setICPremium(i);
                    this.modelarray[i].iCPremium = this.modelarray[i].iCPremium * 1 + (premiumpre) * 1;
                    console.log('international coverage premium for 2 year ' + this.modelarray[i].iCPremium);
                    age--;
                    this.modelarray[i].age = age;
                }
                if (this.tenure == '3 Year') {
                    ...
                    age++;
                    this.modelarray[i].age = age;
                    let premiumprepre: number = this.modelarray[i].iCPremium;
                    this.setICPremium(i);
                    this.modelarray[i].iCPremium = this.modelarray[i].iCPremium * 1 + (premiumprepre) * 1;
                    console.log('international coverage premium for 3 year ' + this.modelarray[i].iCPremium);
                    age--;
                    age--;
                    this.modelarray[i].age = age;
                ...
                if (this.modelarray[i].iCPremium !== 0) {
                    this.internationalCoveragePremium = this.internationalCoveragePremium * 1 + this.modelarray[i].iCPremium * 1;
                }
            }
        }
        setTimeout(() => {
            if (this.tenure == '2 Year') {
                this.internationalCoveragePremium = this.internationalCoveragePremium * 0.925;
                this.internationalCoveragePremium = Math.round(this.internationalCoveragePremium);
            }
            if (this.tenure == '3 Year') {
                this.internationalCoveragePremium = this.internationalCoveragePremium * 0.9;
                this.internationalCoveragePremium = Math.round(this.internationalCoveragePremium);
            }

            if ((this.adultcount * 1 + this.kidcounter * 1) == 2 && this.policyType == 'multiIndividual') {
                this.internationalCoveragePremium = this.internationalCoveragePremium * 0.95;
            }
            if ((this.adultcount * 1 + this.kidcounter * 1) >= 3 && this.policyType == 'multiIndividual') {
                this.internationalCoveragePremium = this.internationalCoveragePremium * 0.90;
            }
    ...
    /// hospital daily cash
    setSIHospitalCash(event: any) {
        this.hCSI = event.detail.value;
        this.hospitalCashPremium = 0;
        this.selectHospitalCash();
    }
    ...
    selectHospitalCash() {
        ...
        for (let i = 0; i < this.modelarray.length; i++) {
            ...
            if (this.modelarray[i].selected) {
                if (this.modelarray[i].gender == 'Female') { gender = 0 }
                if (this.modelarray[i].gender == 'Male') { gender = 1 }

                y = this.hospitalmaster.hospitalcash.filter((x: any) => {
                    if (x['age'] == this.modelarray[i].age && x['gender'] == gender && x['sumInsured'] == this.hCSI)
                        return x;
                });
                ...
                this.modelarray[i].hCPremium = p;
                this.modelarray[i].hCPremium = parseInt(this.modelarray[i].hCPremium).toFixed(4)
                console.log(this.modelarray[i].member + ' HC premium for 1 year >>> ' + this.modelarray[i].hCPremium);
                ...
                if (this.tenure == '2 Year') {
                    ...
                    if (this.modelarray[i].selected) {
                        ...
                        this.modelarray[i].hCPremium = this.modelarray[i].hCPremium * 1 + p * 1;
                        console.log(this.modelarray[i].member + 'HC premium for 2 year >>> ' + this.modelarray[i].hCPremium);
                        age--;
                        this.modelarray[i].age = age;
                    }
                }
                if (this.tenure == '3 Year') {
                    ...
                    console.log('hospital cash premium for 3 year ' + this.modelarray[i].hCPremium);
                    age--;
                    age--;
                    this.modelarray[i].age = age;
                }
            }
            if (this.modelarray[i].hCPremium !== 0) {
                this.hospitalCashPremium = this.hospitalCashPremium * 1 + this.modelarray[i].hCPremium * 1;
            }
            this.coverArray[5].premium = this.hospitalCashPremium;
    ...
    removeHospitalCash() {
        for (let i = 0; i < this.modelarray.length; i++) {
            if (this.modelarray[i]) {
                this.modelarray[i].hospitalcashselected = false;
                this.modelarray[i].hCPremium = 0;
            };
        }
        this.hospitalCashPremium = 0;
        this.coverArray[5].premium = '';

        this.findFinalPremium();
    }

    /// Future Secure
    selectMemberFutureSecure(id: any) {
        // if (this.modelarray[id].futuresecure == true) { this.modelarray[id].futuresecure = false }
        // else { this.modelarray[id].futuresecure = true };
        this.selectFutureSecure();
    ...
    selectFutureSecure() {
        ...
        let cost: any = 0;
        console.log('in select future secure >> ' + this.policyType)
        this.futureSecurePremium = 0;
        if (this.policyType == 'multiIndividual') {
            for (let i = 0; i < this.modelarray.length; i++) {
                if (this.modelarray[i].selected) {
                    if (this.modelarray[i].futuresecure) {
                        costobject = this.dataService.futureSecurePremium.filter((x: any) => {
                        ...
                        console.log(this.modelarray[i].member + ' futuresecure premium 1 yr >>' + cost);
                        this.modelarray[i].fSPremium = cost * 1;

                        if (this.tenure == '2 Year') {
                            cost = costobject[0][this.modelarray[i].sum];
                            let costobject2 = this.dataService.futureSecurePremium.filter((x: any) => {
                                if (x['minAge'] < this.modelarray[i].age && x['maxAge'] > this.modelarray[i].age && x['adultCount'] == 1
                                    && x['childCount'] == 0)
                                    return x;
                            });
                            ...
                            console.log(this.modelarray[i].member + ' futuresecure premium for 2 year>>' + cost)
                            this.modelarray[i].fSPremium = cost;
                        ...
                        if (this.tenure == '3 Year') {
                            ...
                            b++;
                            this.modelarray[i].age = b.toString();
                            let costobject3 = this.dataService.futureSecurePremium.filter((x: any) => {
                            ...
                            let costobject4 = this.dataService.futureSecurePremium.filter((x: any) => {
                                if (x['minAge'] <= tempselfage && x['maxAge'] >= tempselfage && x['adultCount'] == 1
                                    && x['childCount'] == 0)
                                    return x;
                            });
                            ...
                            console.log(this.modelarray[i].member + ' futuresecure premium for 3 year >>' + cost);
                            this.modelarray[i].fSPremium = cost;

                        }
                        this.futureSecurePremium = this.futureSecurePremium * 1 + cost * 1;
                    }
                }
            }
        }
        ...
        if (this.policyType == 'familyFloater') {
            ...
            if (this.tenure == '2 Year') {
                ...
                console.log(this.modelarray[0].member + ' futuresecure premium for 2 year>>' + cost)
                this.futureSecurePremium = cost;
                console.log(cost)
            ...
            if (this.tenure == '3 Year') {
                ...
                console.log(this.modelarray[0].member + ' futuresecure premium for 3 year >>' + cost)
                this.futureSecurePremium = cost;
                console.log(cost)
            }

        }
        console.log('future secure added ' + cost)
        this.coverArray[7].premium = cost;
    ...
    removeFutureSecure() {
        this.futuresecureselected = false;
        for (let i = 0; i < this.modelarray.length; i++) {
            if (this.modelarray[i]) {
                this.modelarray[i].futuresecure = false;
                this.modelarray[i].fCPremium = 0;
            };
        }

        this.futureSecurePremium = 0;
        this.coverArray[7].premium = '';
        this.findFinalPremium();
    }

    /// cancer hospitalization
    selectMemberCancerHospitalization(id: any) {
        // if (this.modelarray[id].cancerhospitalization == true) { this.modelarray[id].cancerhospitalization = false }
        // else { this.modelarray[id].cancerhospitalization = true };
        this.selectCancerHospitalization();
    }
    ...
    selectCancerHospitalization() {
        ...
        if (this.policyType == 'multiIndividual') {
            for (let i = 0; i < this.modelarray.length; i++) {
                if (this.modelarray[i].selected) {
                    if (this.modelarray[i].cancerhospitalization) {
        ...
        this.coverArray[8].premium = cost;
        setTimeout(() => {
            this.findFinalPremium()
        }, 500)
    }
...
for(let i=0;i<this.coverArray.length;i++){
  this.coverArray[i].selected=false;
  this.coverArray[i].premmium=0;
}
    }
    ...
    inccounter(i: any, key: any) {
        if (this.policyType == 'familyFloater') {
            this.policyType = 'multiIndividual';
        }
        this.modelarray[i].dieseasecounter = this.modelarray[i].dieseasecounter * 1 + 1 * 1
        this.setchronic(i, key)

    }
    deccounter(i: any, key: any) {
        this.modelarray[i].dieseasecounter = this.modelarray[i].dieseasecounter * 1 - 1 * 1
        this.setchronic(i, key)
    }
    setchronic(id: any, key: any) {
        if (this.modelarray[id].chronic == 'NCHR') {
            this.modelarray[id].chronic = 'PE002';
            console.log('chronic set>> ' + this.modelarray[id].member + ' ' + this.modelarray[id].chronic);
            this.calDieseasePremium()

            return;
        }
        if (this.modelarray[id].pE003 == '1' && this.modelarray[id].pE002 == '0') {
            this.modelarray[id].chronic = 'PE009';
            console.log('chronic set>> ' + this.modelarray[id].member + ' ' + this.modelarray[id].chronic);
            this.calDieseasePremium()

            return;
        }
        if (this.modelarray[id].pE009 == '1' && this.modelarray[id].pE002 == '0' && this.modelarray[id].pE003 == '0') {
            this.modelarray[id].chronic = 'PE009';
            console.log('chronic set>> ' + this.modelarray[id].member + ' ' + this.modelarray[id].chronic);
            this.calDieseasePremium()
        ...
        if (this.modelarray[id].pE010 == '1' && this.modelarray[id].pE002 == '0' && this.modelarray[id].pE003 == '0' && this.modelarray[id].pE009 == '0') {
            this.modelarray[id].chronic = 'PE010';
            console.log('chronic set>> ' + this.modelarray[id].member + ' ' + this.modelarray[id].chronic);
            this.calDieseasePremium()

            return;
        }
        if (this.modelarray[id].pE010 == '0' && this.modelarray[id].pE002 == '0' && this.modelarray[id].pE003 == '0' && this.modelarray[id].pE009 == '0') {
    ...
    calDieseasePremium() {
        let y: any;
        this.dieseasepremium = 0;
        for (let i = 0; i < this.modelarray.length; i++) {
            if (this.modelarray[i].dieseasecounter == 0) {
                this.modelarray[i].chronic = 'NCHR'
            }

            y = this.infoService.DieseaseData.filter((x: any) => {
                if (x['pE002'] == this.modelarray[i].pE002 &&
                    x['pE003'] == this.modelarray[i].pE003 &&
                    x['pE009'] == this.modelarray[i].pE009 &&
                    x['pE010'] == this.modelarray[i].pE010
                )
                    return x;
            }
            );

            this.modelarray[i].dieseasepremium = 0;
            if (y.length !== 0) {
                this.modelarray[i].dieseasepremium = y[0]['premium'];
                console.log(this.modelarray[i].member + " dieseasepremium >> " + this.modelarray[i].dieseasepremium)
            }
        }
    ...
    nextoncoverspage() {
        ...
        this.quoteobject.premium = this.basicpremium;
